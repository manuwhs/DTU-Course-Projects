...
[Tout_ESDIRK23,Xout_ESDIRK23,Gout_ESDIRK23,Eout_ESDIRK23,info,stats] = ESDIRK(fun,jac,t0,tfinal,x0,h0,absTol,relTol,method,mu);
...
hold on
    ...
    plot(Tout_ESDIRK23, log(sqrt(Eout_ESDIRK23(:,2).^2 + Eout_ESDIRK23(:,1).^2 )), 'color',rand(1,3), 'LineWidth',lw)
