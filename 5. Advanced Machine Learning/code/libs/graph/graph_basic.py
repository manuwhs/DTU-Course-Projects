...
def set_subplots(self, nr, nc, projection = "2d"):
    self.init_figure()
...
def next_subplot(self, projection = "2d"):
    ...
    if (self.subplotting_mode == 1):
        if (projection == "2d"):
            ax = plt.subplot(self.G[self.nri, self.nci])
        elif(projection == "3d"):
            ax = plt.subplot(self.G[self.nri, self.nci], projection='3d')
        elif (projection == "polar"):
            ax = plt.subplot(self.G[self.nri, self.nci],projection='polar')
...
#            ax = self.fig.add_axes(position, projection = projection)
        ...
        if (projection == "2d"):
            ax = plt.subplot2grid((self.nr,self.nc),(self.nri, self.nci))
        elif(projection == "3d"):
            ax = plt.subplot2grid((self.nr,self.nc),(self.nri, self.nci), projection='3d')
        elif(projection == "polar"):
            ax = plt.subplot2grid((self.nr,self.nc),(self.nri, self.nci), projection= 'polar')
            print "subplot2grid"
