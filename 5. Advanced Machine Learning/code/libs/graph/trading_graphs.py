...
def plotMACD(self, timeData, nslow = 26, nfast = 12, nema = 9, 
    ...
    emaslow = timeData.EMA(n = 26)
    emafast = timeData.EMA(n = 12)

    gl.plot(date, MACD, color='#4ee6fd', lw=2, nf = 0)
    gl.plot(date, MACDsign, color='#e1edf9', lw=1, nf = 0)
    gl.fill_between(date, MACDdiff, 0, alpha=0.5, facecolor=fillcolor, edgecolor=fillcolor)
