# cd /Desktop/DTU\ Lec/1st\ Semester/5.\ Computational\ Tools\ for\ Big\ Data/2.Assingments/67
...
### FAILURE. The map version didnt work.
#        def maptest(keys1, keys2):
#            key_aux = keys1 + "_" + keys2
#            print keys1,keys2
#            yield key_aux, [Matrix_A[keys1], Matrix_A[keys2]]
#            
#        map(maptest, Matrix_A.keys(), Matrix_A.keys())
...
#            for j in Matrix_A.keys():
#                key_aux = i + "_" + j
#                yield key_aux, [Matrix_AA[i], Matrix_A[j]]
    ...
    # Now we have both matrices in [A,B] in the key: matrices"
